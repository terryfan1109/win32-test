...
namespace RpcTransport
{
    ...
    public class RpcServerApi : IDisposable
    {
        ...
        private void RpcEntryPoint2(IntPtr pAsyncState, IntPtr clientHandle, uint szInput, IntPtr input, out uint szOutput, out IntPtr output)
        {
          ...
          try
          {
            ...
            if (bytesOut == null)
            {
              ...
              RpcAsyncCompleteCall(pAsyncState, ref result);
              return;
            }
            ...
            RpcAsyncCompleteCall(pAsyncState, ref result2);
            return;
          }
          catch (Exception ex)
          {
      ...
      #region RPC async functions
        ...
        private static extern RpcError RpcAsyncGetCallStatus(IntPtr pSsyncState);
        ...
        private static extern RpcError RpcAsyncCompleteCall(IntPtr pSsyncState, ref IntPtr result);
        ...
        private static extern RpcError RpcAsyncAbortCall(IntPtr pSsyncState, uint result);
        ...
        private static extern RpcError RpcAsyncAbortCall(IntPtr pSsyncState, bool fAbort);
      #endregion
    }
}