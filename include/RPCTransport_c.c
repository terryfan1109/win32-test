...
static const RPC_CLIENT_INTERFACE RPCTransport___RpcClientInterface =
    {
...
RPC_IF_HANDLE RPCTransport_v1_0_c_ifspec = (RPC_IF_HANDLE)& RPCTransport___RpcClientInterface;

extern const MIDL_STUB_DESC RPCTransport_StubDesc;

static RPC_BINDING_HANDLE RPCTransport__MIDL_AutoBindHandle;
    ...
    /* [size_is][size_is][out] */ byte **output)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&RPCTransport_StubDesc,
                  (PFORMAT_STRING) &RPCTransport__MIDL_ProcFormatString.Format[0],
    ...
    /* [size_is][size_is][out] */ byte **output)
{
    ...
    NdrAsyncClientCall(
                      ( PMIDL_STUB_DESC  )&RPCTransport_StubDesc,
                      (PFORMAT_STRING) &RPCTransport__MIDL_ProcFormatString.Format[58],
                      ( unsigned char * )&executeAsync_AsyncHandle);
...
static const MIDL_STUB_DESC RPCTransport_StubDesc = 
    {
    (void *)& RPCTransport___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &RPCTransport__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
