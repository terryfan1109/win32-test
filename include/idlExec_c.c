...
static const RPC_CLIENT_INTERFACE IRpcExec___RpcClientInterface =
    {
...
RPC_IF_HANDLE IRpcExec_v1_0_c_ifspec = (RPC_IF_HANDLE)& IRpcExec___RpcClientInterface;

extern const MIDL_STUB_DESC IRpcExec_StubDesc;

static RPC_BINDING_HANDLE IRpcExec__MIDL_AutoBindHandle;
    ...
    /* [size_is][size_is][out] */ byte **arReturn)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IRpcExec_StubDesc,
                  (PFORMAT_STRING) &idlExec__MIDL_ProcFormatString.Format[0],
...
static const COMM_FAULT_OFFSETS IRpcExec_CommFaultOffsets[] = 
{
	{ -1, -1 } 	/* x86 Offsets for Exec */
};


static const MIDL_STUB_DESC IRpcExec_StubDesc = 
    {
    (void *)& IRpcExec___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &IRpcExec__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
