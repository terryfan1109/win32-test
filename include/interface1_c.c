...
static const RPC_CLIENT_INTERFACE AnInterface___RpcClientInterface =
    {
...
RPC_IF_HANDLE AnInterface_v1_0_c_ifspec = (RPC_IF_HANDLE)& AnInterface___RpcClientInterface;

extern const MIDL_STUB_DESC AnInterface_StubDesc;

static RPC_BINDING_HANDLE AnInterface__MIDL_AutoBindHandle;
    ...
    /* [size_is][in] */ KeyValuePair *pKvs)
{
    ...
    _RetVal = NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &interface1__MIDL_ProcFormatString.Format[0],
    ...
    /* [size_is][size_is][out] */ KeyValuePair **ppKvs)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&AnInterface_StubDesc,
                  (PFORMAT_STRING) &interface1__MIDL_ProcFormatString.Format[46],
                  ( unsigned char * )&IDL_handle);
    return ( HRESULT  )_RetVal.Simple;
...
static const MIDL_STUB_DESC AnInterface_StubDesc = 
    {
    (void *)& AnInterface___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &AnInterface__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
